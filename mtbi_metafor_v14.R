...
GFAP_data <- data.frame(
  study = c("Oris 2024", "Bazarian 2021", "Papa 2022",
            "Chayoua 2024",       # CORRECTED v14: TP/FP/FN/TN from full text Table 2
            "Legramante 2024", "Jones 2020", "Lagares 2024 (BRAINI)", "Puravet 2025",
            "Milevoj 2025"),      # NEW v14: 9th study, 12 European centres
  TP = c(18, 24, 52,  57,  7, 33,  68,  99, 107),
  FP = c(61,199,392, 157, 89,425, 477, 285, 529),
  FN = c( 0,  1,  1,   2,  0,  0,   2,   1,   5),
  TN = c(127,167,413,  37, 34,221, 663, 373, 181)
)
...
plot_forest(GFAP_res,  "#1B4F8A", "Fig2_forest_gfap_v14.pdf",  2)
plot_forest(S100B_res, "#1A6B3C", "Fig3_forest_s100b_v14.pdf", 3)
...
plot_sroc(GFAP_res, S100B_res, "Fig4_sroc_v14.pdf")
...
plot_clinical_summary(GFAP_res, S100B_res, "Fig5_clinical_summary_v14.pdf")
...
plot_funnel(GFAP_res,  "#1B4F8A", "FigS1_funnel_gfap_v14.pdf")
plot_funnel(S100B_res, "#1A6B3C", "FigS1_funnel_s100b_v14.pdf")
...
cat("\n Files generated:\n")
for (f in c("Fig2_forest_gfap_v14.pdf","Fig3_forest_s100b_v14.pdf",
            "Fig4_sroc_v14.pdf","Fig5_clinical_summary_v14.pdf",
            "FigS1_funnel_gfap_v14.pdf","FigS1_funnel_s100b_v14.pdf"))
  cat("  ", f, "\n")