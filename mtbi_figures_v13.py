#!/usr/bin/env python3
"""
mTBI Biomarker DTA Meta-Analysis — Publication Figures v13
=============================================================
Data source  : R v13 script (mtbi_metafor_v13.R)
Pooled stats : R metafor REML (hardcoded — primary method)
...
# =============================================================================
# 1. RAW 2×2 DATA  (from R v13 — BEFORE continuity correction)
# =============================================================================
...
GFAP = dict(
    ...
    CT_pos   = 345,
    prev_pct = 7.6,
    studies  = ["Oris 2024", "Bazarian 2021", "Papa 2022", "Chayoua 2024",
                "Legramante 2024", "Jones 2020",
                "Lagares 2024\n(BRAINI)", "Puravet 2025"],
    ...
    # ── Pooled (R metafor REML v13) ──────────────────────────────────────────
    pool_se    = 0.976, pool_se_lo = 0.951, pool_se_hi = 0.988,
    pool_sp    = 0.493, pool_sp_lo = 0.403, pool_sp_hi = 0.584,
    I2_se=0,   tau2_se=0.000, Q_se=2.4,   pQ_se=0.969,
    I2_sp=97,  tau2_sp=0.340, Q_sp=219.3, pQ_sp=0.000,
    NPV=99.60, CT_avoided=45.7, missed_1000=1.9,
...
S100B = dict(
    ...
    CT_pos   = 242,
    prev_pct = 6.8,
    studies  = ["Oris 2024", "Oris 2021", "Hopman 2023",
                "Seidenfaden 2021\n(PreTBI I)",
                "Rogan 2023\n(BRAIN)", "Puravet 2026"],
    ...
    # ── Pooled (R metafor REML v13) ──────────────────────────────────────────
    pool_se    = 0.951, pool_se_lo = 0.909, pool_se_hi = 0.974,
    pool_sp    = 0.241, pool_sp_lo = 0.194, pool_sp_hi = 0.295,
    I2_se=0,   tau2_se=0.000, Q_se=3.2,  pQ_se=0.673,
    I2_sp=89,  tau2_sp=0.093, Q_sp=46.7, pQ_sp=0.000,
    NPV=98.54, CT_avoided=22.4, missed_1000=3.3,
...
if __name__ == '__main__':
    ...
    print("Generating figures (data aligned with R metafor REML v13)...\n")

    plot_forest(GFAP,  2, "Fig2_forest_gfap_v13.png")
    plot_forest(S100B, 3, "Fig3_forest_s100b_v13.png")
    plot_sroc(GFAP, S100B,       "Fig4_sroc_v13.png")
    plot_clinical_summary(GFAP, S100B, "Fig5_clinical_summary_v13.png")
    plot_funnel(GFAP, S100B,     "FigS1_funnel_v13.png")
